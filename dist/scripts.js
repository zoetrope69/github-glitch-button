function onLoad() {
    ...
    const isPrivate = labelElement && labelElement.innerText.includes('Private')
    if (isPrivate) {
        console.info('Private repo')
        return 
    }

    const repoUrl = `${location.href}.git`
